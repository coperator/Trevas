...
public class JoinTest {
  ...
  private final InMemoryDataset dataset1 =
      new InMemoryDataset(
          List.of(
              List.of("a", 1L, 2L),
              List.of("b", 3L, 4L),
  ...
  private final InMemoryDataset dataset2 =
      new InMemoryDataset(
          List.of(
              List.of(9L, "a", 10L),
              List.of(11L, "b", 12L),
  ...
  private final InMemoryDataset dataset3 =
      new InMemoryDataset(
          List.of(
              List.of(16L, "a", 17L),
              List.of(18L, "b", 19L),
  ...
  public void testInnerJoin() throws ScriptException {
    ...
    assertThat(resultInner.getDataAsList())
        .containsExactlyInAnyOrder(
            Arrays.asList("a", 2L, 16L, 17L, 10L, 1L, 9L),
            Arrays.asList("b", 4L, 18L, 19L, 12L, 3L, 11L),
            Arrays.asList("c", 6L, 22L, 23L, 15L, 5L, 14L),
    ...
    assertThat(resultInner.getDataStructure())
        .containsValues(
            new Structured.Component("name", String.class, Dataset.Role.IDENTIFIER),
            new Structured.Component("age", Long.class, Dataset.Role.MEASURE),
            new Structured.Component("weight", Long.class, Dataset.Role.MEASURE),
  ...
  public void testCrossJoin() throws ScriptException {
    ...
    assertThat(resultCross.getDataAsList())
        .containsExactlyInAnyOrder(
    ...
    assertThat(resultCross.getDataStructure().values())
        .containsExactly(
