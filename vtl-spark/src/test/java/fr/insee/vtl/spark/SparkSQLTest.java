...
public class SparkSQLTest {
  ...
  public void setUp() throws SQLException, IOException {
    ...
    statement.executeUpdate(
        "insert into ds1 values (1, 'string1', 'string1', 1, 1, 1.2, 1.2, 'true', 1.2, 100, '2001-01-01T00:00:00Z', '2001-01-01')");
    statement.executeUpdate(
        "insert into ds1 values (2, 'string2', 'string2', 2, 2, 5.2, 5.2, 'false', 5.2, 200, '2002-01-01T00:00:00Z', '2002-01-01')");
    statement.executeUpdate(
        "insert into ds1 values (3, 'string3', 'string3', 3, 3, 3.2, 3.2, 'true', 3.2, 300, '2003-01-01T00:00:00Z', '2003-01-01')");
    statement.executeUpdate(
        "insert into ds1 values (4, 'string4', 'string4', 4, 4, 4.2, 4.2, 'false', 4.2, 400, '2004-01-01T00:00:00Z', '2004-01-01')");
  ...
  public void testReadSql() throws ScriptException {
    ...
    List<List<Object>> roundedDs2 =
        ds2.getDataAsList().stream()
            .map(
                line ->
                    line.stream()
                        .map(
