...
public class PivotTest {
  ...
  @Test
  public void testPivot() throws ScriptException {
    ...
    engine.eval("DS_r := Ds_1 [ pivot Id_2, Me_1 ];" + "DS_r2 := Ds_2 [ pivot Id_2, Me_1 ];");
    ...
    var result2 = (Dataset) context.getAttribute("DS_r2");
    assertThat(result2.getDataAsList())
        .containsExactlyInAnyOrder(Arrays.asList(1L, 5L, 2L, 7L), Arrays.asList(2L, 3L, 4L, 9L));
