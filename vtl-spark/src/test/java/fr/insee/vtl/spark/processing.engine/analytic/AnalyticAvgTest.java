...
public class AnalyticAvgTest {
  ...
  public void testAnAvgWithCalcClause() throws ScriptException {
    ...
    * */
    ...
    engine.eval(
        "res := ds1 [ calc avg_Me_1:= avg ( Me_1 over ( partition by Id_1,Id_2 order by Year) )];");
  ...
  public void testAnAvgWithPartitionOrderByRangeClause() throws ScriptException {
    ...
    * */
    ...
    engine.eval(
        "res := avg ( ds1 over ( partition by Id_1 order by Year range between 1 preceding and 1 following) );");
    assertThat(engine.getContext().getAttribute("res")).isInstanceOf(Dataset.class);
