...
public class AnalyticMaxTest {
  ...
  public void testAnMaxWithCalcClause() throws ScriptException {
    ...
    * */
    ...
    assertThat(actual)
        .containsExactly(
            Map.of(
                "Id_1", "A", "Id_2", "XX", "Year", 2000L, "Me_1", 3L, "Me_2", 1.0D, "max_Me_1", 3L),
            Map.of(
                "Id_1", "A", "Id_2", "XX", "Year", 2001L, "Me_1", 4L, "Me_2", 9.0D, "max_Me_1", 4L),
            Map.of(
                "Id_1", "A", "Id_2", "XX", "Year", 2002L, "Me_1", 7L, "Me_2", 5.0D, "max_Me_1", 7L),
            Map.of(
                "Id_1", "A", "Id_2", "XX", "Year", 2003L, "Me_1", 6L, "Me_2", 8.0D, "max_Me_1", 7L),
            Map.of(
                "Id_1", "A", "Id_2", "YY", "Year", 2000L, "Me_1", 9L, "Me_2", 3.0D, "max_Me_1", 9L),
            Map.of(
                "Id_1", "A", "Id_2", "YY", "Year", 2001L, "Me_1", 5L, "Me_2", 4.0D, "max_Me_1", 9L),
            Map.of(
                "Id_1",
                "A",
                "Id_2",
  ...
  public void testAnMaxWithPartitionOrderByRangeClause() throws ScriptException {
    ...
    * */
    ...
    engine.eval(
        "res := max ( ds1 over ( partition by Id_1 order by Year range between 1 preceding and 1 following) );");
    assertThat(engine.getContext().getAttribute("res")).isInstanceOf(Dataset.class);
